...
exports.createCards = async (game_id) => {
    const cardData = [
        ...
        { label: "Karl", name: "mysticism", epoch: 1, recycle: true, state: "stack", type: "event", game: game_id },
        ...
        { label: "Holz", name: "wood", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Stein", name: "stone", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Seide", name: "silk", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Stoffe/Wein", name: "clothWine", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Gewürze", name: "spice", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Elfenbein/Gold", name: "ivoryGold", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Stein", name: "stone", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Wolle", name: "whool", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Wolle", name: "whool", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Pelze", name: "fur", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Metall", name: "metal", epoch: 1, recycle: true, state: "stack",  type: "biom", game: game_id },
        ...
        { label: "Holz", name: "wood", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Holz", name: "wood", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Seide", name: "silk", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Getreide", name: "grain", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Getreide", name: "grain", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Stoffe", name: "cloth", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Gewürze", name: "spice", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Wein", name: "wine", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        { label: "Metall", name: "metal", epoch: 2, recycle: true, state: "stack",  type: "biom", game: game_id },
        ...
        { label: "Seide", name: "silk", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id },
        { label: "Stoffe", name: "cloth", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id },
        { label: "Gold", name: "gold", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id },
        { label: "Gewürze", name: "spice", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id },
        { label: "Wein", name: "wine", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id },
        { label: "Pelze", name: "fur", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id },
        { label: "Metall", name: "metal", epoch: 3, recycle: false, state: "stack",  type: "biom", game: game_id }
    ];
