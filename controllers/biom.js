...
exports.createBioms = async (game_id) => {
    const biomsData = [
        ...
        { name: 'Getreide', className: 'grain', color: '#ddaa44', revenues: [4, 16, 36, 64, 100, 144, 196, 256], epoch: "0 / 2 / 0", availability: 'neutral', game: game_id },
        ...
        { name: 'Wein', className: 'wine', color: '#660000', revenues: [5, 20, 45, 80, 125, 180], epoch: "1*/ 1 / 1", availability: 'neutral', game: game_id },
